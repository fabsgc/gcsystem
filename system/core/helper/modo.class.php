		...
		class modo{
			...
			*/
			...
			protected function  _setInsulte(){
				...
				if($domXml->load(MODOCONFIG)){
					$this->_addError('fichier ouvert : '.MODOCONFIG, __FILE__, __LINE__, ERROR);
					...
					$this->_addError('Le fichier '.MODOCONFIG.' n\'a pas pu être ouvert', __FILE__, __LINE__, ERROR);
				}
			}
