...
<div id="GCsysytem_dev">
	...
	<div class="GCsysytem_dev_content">
		<div class="GCsysytem_dev_content_logo"><img src="<?php echo ($IMG_PATH); ?>time.png" title="<?php echo "temps d'exécution"; ?>temps d'exécution"/><img src="<?php echo ($IMG_PATH); ?>memory.png" title="<?php echo "mémoire utilisée"; ?>mémoire utilisée"/></div>
	...
	<div class="GCsysytem_dev_content" style="width: 275px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="<?php echo ($IMG_PATH); ?>sql.png" title="<?php echo "requête sql exécutées"; ?>requête sql exécutées"/></div>
		<div class="GCsysytem_dev_content_content">
	...
	<div class="GCsysytem_dev_content" style="width: 250px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="<?php echo ($IMG_PATH); ?>tpl.png" title="<?php echo "fichier de template inclus."; ?>fichier de template chargés"/></div>
		<div class="GCsysytem_dev_content_content">
			<div id="GCsysytem_dev_content_zone" style="width: 219px;">
			<?php echo ($tpl); ?>
			</div>
