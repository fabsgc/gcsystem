...
<div id="GCsysytem_dev">
	...
	<div class="GCsysytem_dev_content" style="width: 250px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="{{def:IMG_PATH}}gcs/http.png" title="{{lang:gc_fichierinclus}}"/></div>
	...
	<div class="GCsysytem_dev_content" style="width: 275px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="{{def:IMG_PATH}}gcs/sql.png" title="{{lang:gc_requetesql}}"/></div>
		<div class="GCsysytem_dev_content_content">
	...
	<div class="GCsysytem_dev_content" style="width: 250px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="{{def:IMG_PATH}}gcs/tpl.png" title="{{lang:gc_fichiertpl}}"/></div>
		<div class="GCsysytem_dev_content_content">
			<div id="GCsysytem_dev_content_zone" style="width: 219px;">
			{tpl}
			</div>
	...
	<div class="GCsysytem_dev_content" style="width: 200px; padding: 0px;">
		<div class="GCsysytem_dev_content_logo"><img src="{{def:IMG_PATH}}gcs/arbo.png" title="{{lang:gc_vargetpost}}"/></div>
		<div class="GCsysytem_dev_content_content">
